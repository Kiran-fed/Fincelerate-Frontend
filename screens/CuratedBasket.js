      ...
      >
        ...
        <View style={[styles.fundcontainer, isMobile && styles.fundcontainerMobile]}>
          ...
          {sections.map((section, sectionIndex) => (
            <View 
              key={section.id} 
              style={[styles.sectionContainer, isMobile && styles.sectionContainerMobile, isTablet && styles.sectionContainerTablet]}
        ...
        <View style={styles.footerSection}>
          <View style={[styles.footerContent, isMobile && styles.footerContentMobile]}>
            ...
            <View style={[styles.footerLeft, isMobile && styles.footerLeftMobile]}>
              ...
              <Text style={[styles.footerTagline, isMobile && styles.footerTaglineMobile, isTablet && styles.footerTaglineTablet]}>
            ...
            <View style={[styles.footerRight, isMobile && styles.footerRightMobile]}>
              <View style={[styles.footerColumn, isMobile && styles.footerColumnMobile]}>
                <Text style={[styles.footerColumnTitle, isMobile && styles.footerColumnTitleMobile, isTablet && styles.footerColumnTitleTablet]}>
                  Quick Links
                </Text>
                <TouchableOpacity style={styles.footerLink}>
                  <Text style={[styles.footerLinkText, isMobile && styles.footerLinkTextMobile, isTablet && styles.footerLinkTextTablet]}>
                    Link 1
                  </Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.footerLink}>
          ...
          <View style={[styles.contactInfo, isMobile && styles.contactInfoMobile]}>
            <View style={[styles.contactItem, isMobile && styles.contactItemMobile]}>
              ...
              <Text style={[styles.contactText, isMobile && styles.contactTextMobile, isTablet && styles.contactTextTablet]}>
                +91-9611248691
              </Text>
            </View>
            <View style={[styles.contactItem, isMobile && styles.contactItemMobile]}>
          ...
          <View style={styles.copyrightContainer}>
            <Text style={[styles.copyrightText, isMobile && styles.copyrightTextMobile, isTablet && styles.copyrightTextTablet]}>
...
//     // Find which section is currently in view
//     const scrollPosition = scrollY + (isMobile ? -400 : -620); // Fixed offset for proper section detection
...
//             <View 
//               key={section.id} 
//               style={[styles.sectionContainer,  isDesktop && styles.categoryContainerDesktop, isMobile && styles.sectionContainerMobile, isTablet && styles.sectionContainerTablet]}
